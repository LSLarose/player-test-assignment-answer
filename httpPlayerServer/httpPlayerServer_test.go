...
func TestAuthenticate(t *testing.T) {
	...
	err := authenticateRequests(new(ResponseWriterStub), CLIENT_ID, "aHI&YFfaOJ0sd92dsOgSKh82gf4h3KgDhO)UJ(")
...
func TestAuthenticateFailClientId(t *testing.T) {
	...
	err := authenticateRequests(new(ResponseWriterStub), CLIENT_ID, AUTH_TOKEN)
